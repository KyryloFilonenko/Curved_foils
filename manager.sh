        ...
        if [ "$SIMU_AGREEMENT" = "yes" ]; then
            ...
            for simu_name in "${SIMU_NAME[@]}"; do
                ...
                for i in $(seq 0 $NUM_FOL); do
                    ...
                    sed "s|\$1|$TIME|g; s|\$2|$SIMU_DIR|g; s|\$3|$i|g; s|\$4|$simu_name|g; s|\$5|$NUM_EV|g; s|\$6|$TK_DIR|g" "$FAL_DIR/TEMP_send.sh" > "$SIMU_DIR/$i/send_$simu_name.sh"
